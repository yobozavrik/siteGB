...
// Categories matching Poster POS (Постер лайв) and Galya Baluvana Chernivtsi menu.
export const categories: Category[] = [
  { slug: "vareniki", title: "Вареники", blurb: "Домашні вареники ручного ліплення — з картоплею, капустою, лівером, м'ясом, сиром, вишнею та ягодами.", sort: 1 },
  { slug: "pelmeni", title: "Пельмені та хінкалі", blurb: "Тонке еластичне тісто, соковита м'ясна начинка, ручне ліплення.", sort: 2 },
  { slug: "mlyntsi", title: "Млинці та бендерики", blurb: "Тонкі солодкі та солоні налисники, хрусткі трикутні бендерики.", sort: 3 },
  { slug: "syrnyky", title: "Сирники та запіканки", blurb: "З натурального кисломолочного сиру — класичні, з родзинками, маком, шоколадом.", sort: 4 },
  { slug: "kotlety", title: "Котлети та крученики", blurb: "Котлети по-київськи, Кордон Блю, крученики зі свинини, тефтелі та мітболи.", sort: 5 },
  { slug: "golubtsi", title: "Голубці та перець", blurb: "Загорнуті руками зі свининою та телятиною, пісні з грибами, перець, долма.", sort: 6 },
  { slug: "kartoplyani", title: "Картопляні вироби та зрази", blurb: "Зрази з м'ясом, капустою, грибами, пухкі деруни та картопляники.", sort: 7 },
  { slug: "homilky", title: "Гомілки, нагетси та стріпси", blurb: "Курячі гомілки, нагетси, стріпси та крильця у хрусткій паніровці.", sort: 8 },
  { slug: "kovbasy", title: "Ковбаси та паштет", blurb: "Домашня ковбаса для запікання, ковбаски для гриля, печінковий паштет.", sort: 9 },
  { slug: "pizza-pyrohy", title: "Піца, чебуреки та випічка", blurb: "Соковиті чебуреки, хачапурі, піца, яблучний штрудель, круасани.", sort: 10 },
  { slug: "gotovi", title: "Готові страви та супи", blurb: "Український борщ, домашні супи, лазаньї, кіші та шашлик.", sort: 11 },
];
...
export const products: Product[] = [
  ...
  {
    id: "vareniki-kartoplya-pechinka", slug: "vareniki-z-kartopleyu-ta-pechinkoyu", categorySlug: "vareniki",
    title: "Вареники з картоплею та печінкою", weightGrams: 900, unitLabel: "упаковка 0,9 кг",
    priceUAH: 239, tags: ["hit"],
    composition: "Борошно пшеничне в/ґ, картопля, печінка куряча та яловича, цибуля смажена, олія, сіль, перець, вода.",
    kbju: { kcal: 208, protein: 7, fat: 5, carb: 33 },
    cooking: "Варити 5–6 хв після спливання у підсоленому окропі.",
    storage: "Зберігати за −18 °C до 30 діб.",
    allergens: "Глютен (пшениця).",
    images: PH, isActive: true,
  },
  {
    id: "vareniki-myaso", slug: "vareniki-z-myasom", categorySlug: "vareniki",
    title: "Вареники з м'ясом", weightGrams: 800, unitLabel: "упаковка 0,8 кг",
    priceUAH: 279, tags: ["hit"],
    composition: "Борошно пшеничне в/ґ, свинина, яловичина відварна, цибуля пасерована, сіль, перець чорний, вода.",
    kbju: { kcal: 238, protein: 11, fat: 8, carb: 30 },
    cooking: "Варити 6–7 хв після спливання. Подавати з розтопленим вершковим маслом або шкварками.",
    storage: "Зберігати за −18 °C до 30 діб.",
    allergens: "Глютен (пшениця).",
    images: PH, isActive: true,
  },
  {
    id: "vareniki-liver", slug: "vareniki-z-liverom", categorySlug: "vareniki",
    title: "Вареники з лівером", weightGrams: 800, unitLabel: "упаковка 0,8 кг",
    priceUAH: 229, tags: [],
    composition: "Борошно пшеничне в/ґ, лівер (печінка, серце, легені), цибуля ріпчаста, олія, сіль, перець, вода.",
    kbju: { kcal: 218, protein: 9, fat: 6, carb: 31 },
    cooking: "Варити 5–6 хв після спливання у підсоленій воді.",
    storage: "Зберігати за −18 °C до 30 діб.",
    allergens: "Глютен (пшениця).",
    images: PH, isActive: true,
  },
  ...
  },
  {
    ...
    priceUAH: 239, tags: [],
    composition: "Борошно пшеничне в/ґ, сир кисломолочний, яйце, цибуля зелена, кріп, сіль, вода.",
  ...
  {
    id: "vareniki-solodkyy-syr", slug: "vareniki-z-solodkym-syrom-ta-rodzynkamy", categorySlug: "vareniki",
    title: "Вареники з солодким сиром та родзинками", weightGrams: 700, unitLabel: "упаковка 0,7 кг",
    priceUAH: 249, tags: ["hit"],
    composition: "Борошно пшеничне в/ґ, сир кисломолочний, родзинки, цукор, ванілін, яйце, вода.",
    kbju: { kcal: 228, protein: 10, fat: 5, carb: 35 },
    cooking: "Варити 4–5 хв після спливання у злегка підсоленій або підсолодженій воді.",
    storage: "Зберігати за −18 °C до 30 діб.",
    allergens: "Глютен (пшениця), молоко, яйця.",
    images: PH, isActive: true,
  },
  ...
  {
    id: "vareniki-chornytsya", slug: "vareniki-z-chornaytseyu", categorySlug: "vareniki",
    title: "Вареники з чорницею", weightGrams: 700, unitLabel: "упаковка 0,7 кг",
    priceUAH: 289, tags: ["new"],
    composition: "Борошно пшеничне в/ґ, лісова чорниця, цукор, крохмаль, вода.",
    kbju: { kcal: 214, protein: 4, fat: 2, carb: 45 },
    cooking: "Варити 4–5 хв після спливання. Подавати зі сметаною або вершками.",
    storage: "Зберігати за −18 °C до 30 діб.",
    allergens: "Глютен (пшениця).",
    images: PH, isActive: true,
  },
  ...
  },
  {
    ...
    title: "Млинці з м'ясом (свинина та яловичина)", weightGrams: 500, unitLabel: "упаковка 0,5 кг · 5 шт",
    priceUAH: 349, tags: ["hit"],
    composition: "Борошно пшеничне, молоко, яйце, свинина, яловичина, цибуля смажена, олія, сіль, перець.",
    kbju: { kcal: 236, protein: 12, fat: 12, carb: 20 },
    cooking: "Обсмажити на вершковому маслі по 2–3 хв з кожного боку.",
    storage: "Зберігати за −18 °C до 30 діб.",
    allergens: "Глютен (пшениця), молоко, яйця.",
    images: PH, isActive: true,
  },
  {
    id: "mlyntsi-pechinka", slug: "mlyntsi-z-pechinkoyu", categorySlug: "mlyntsi",
    title: "Млинці з печінкою", weightGrams: 500, unitLabel: "упаковка 0,5 кг · 5 шт",
    priceUAH: 299, tags: [],
    composition: "Борошно пшеничне, молоко, яйце, печінка яловича та куряча, морква, цибуля, масло вершкове, сіль, перець.",
    kbju: { kcal: 212, protein: 10, fat: 8, carb: 24 },
    cooking: "Обсмажити на помірному вогні 2–3 хв з кожного боку.",
    storage: "Зберігати за −18 °C до 30 діб.",
    allergens: "Глютен (пшениця), молоко, яйця.",
    images: PH, isActive: true,
  },
  ...
  {
    id: "mlyntsi-syr-rodzynky", slug: "mlyntsi-nalysnyky-z-syrom-ta-rodzynkamy", categorySlug: "mlyntsi",
    title: "Налисники з сиром та родзинками", weightGrams: 500, unitLabel: "упаковка 0,5 кг · 5 шт",
    priceUAH: 289, tags: ["hit"],
    composition: "Борошно пшеничне, молоко, яйце, сир кисломолочний, родзинки, цукор, ванільний цукор, масло вершкове.",
    kbju: { kcal: 224, protein: 10, fat: 7, carb: 30 },
    cooking: "Розігріти на сковороді з вершковим маслом 4–5 хв або запекти в сметанній заливці 15 хв.",
    storage: "Зберігати за −18 °C до 30 діб.",
    allergens: "Глютен (пшениця), молоко, яйця.",
    images: PH, isActive: true,
  },
  ...
  {
    id: "bendaryky-kurka-motsarela", slug: "bendaryky-z-kurkoyu-ta-motsareloyu", categorySlug: "mlyntsi",
  ...
  {
    id: "bendaryky-myaso", slug: "bendaryky-z-myasom", categorySlug: "mlyntsi",
    title: "Бендерики з м'ясом", weightGrams: 500, unitLabel: "упаковка 0,5 кг",
    priceUAH: 369, tags: ["hit"],
    composition: "Млинцеве тісто (борошно, молоко, яйце), свинина, яловичина, цибуля, сіль, перець чорний.",
    kbju: { kcal: 246, protein: 12, fat: 14, carb: 18 },
    cooking: "Обсмажити на помірному вогні по 3–4 хв з кожного боку до золотистої скоринки.",
    storage: "Зберігати за −18 °C до 30 діб.",
    allergens: "Глютен (пшениця), молоко, яйця.",
    images: PH, isActive: true,
  },
  ...
  {
    id: "kotlety-po-kyivsky", slug: "kotleta-po-kyivsky", categorySlug: "kotlety",
    title: "Котлети по-київськи", weightGrams: 500, unitLabel: "упаковка 0,5 кг · 4 шт",
    priceUAH: 399, tags: ["hit"],
    composition: "Філе куряче відбірне, масло вершкове 82.5%, кріп свіжий, яйце, панірувальні сухарі, борошно, сіль, перець.",
    kbju: { kcal: 278, protein: 16, fat: 18, carb: 12 },
    cooking: "Смажити у великій кількості олії 5–7 хв до скоринки, довести в духовці 180 °C 15 хв.",
    storage: "Зберігати за −18 °C до 30 діб.",
    allergens: "Глютен (пшениця), молоко, яйця.",
    images: PH, isActive: true,
  },
  ...
  {
    id: "kruchenyky-gryby", slug: "kruchenyky-zi-svynyny-z-grybamy", categorySlug: "kotlety",
    title: "Крученики зі свинини з грибами", weightGrams: 600, unitLabel: "упаковка 0,6 кг · ~6 шт",
    priceUAH: 419, tags: ["hit"],
    composition: "Свиняча биточна частина, печериці смажені, цибуля, твердий сир, спеції, олія.",
    kbju: { kcal: 264, protein: 17, fat: 19, carb: 4 },
    cooking: "Обсмажити до золотистого кольору по 3 хв з боку, тушкувати в соусі або духовці 180 °C 25 хв.",
    storage: "Зберігати за −18 °C до 30 діб.",
    allergens: "Молоко.",
    images: PH, isActive: true,
  },
  {
    id: "kruchenyky-chornoslyv", slug: "kruchenyky-zi-svynyny-z-chornoslyvom", categorySlug: "kotlety",
    title: "Крученики зі свинини з чорносливом та горіхом", weightGrams: 600, unitLabel: "упаковка 0,6 кг · ~6 шт",
    priceUAH: 429, tags: [],
    composition: "Свинина відбірна, чорнослив в'ялений, волоський горіх, часник, сіль, суміш перців.",
    kbju: { kcal: 278, protein: 16, fat: 18, carb: 14 },
    cooking: "Запікати у вершковому або сметанному соусі в духовці 180 °C 30–35 хв.",
    storage: "Зберігати за −18 °C до 30 діб.",
    allergens: "Горіхи волоські.",
    images: PH, isActive: true,
  },
  {
    id: "lyulya-kebab", slug: "lyulya-kebab-na-shpagkah", categorySlug: "kotlety",
    title: "Люля-кебаб на шпажках", weightGrams: 500, unitLabel: "упаковка 0,5 кг · ~5 шт",
    priceUAH: 379, tags: ["hit"],
    composition: "Свинина, яловичина, цибуля ріпчаста, кінза, коріандр, зіра, сіль, перець.",
    kbju: { kcal: 254, protein: 15, fat: 20, carb: 3 },
    cooking: "Смажити на грилі, пательні або запікати в духовці 190 °C 20–25 хв.",
    storage: "Зберігати за −18 °C до 30 діб.",
  ...
  {
    id: "pelmeni-indychka", slug: "pelmeni-z-indychkoyu", categorySlug: "pelmeni",
    title: "Пельмені з м'ясом індички", weightGrams: 900, unitLabel: "упаковка 0,9 кг",
    priceUAH: 319, tags: ["hit"],
    composition: "Борошно пшеничне в/ґ, філе індички, цибуля ріпчаста, вершкове масло, вода, сіль, перець.",
    kbju: { kcal: 226, protein: 14, fat: 8, carb: 24 },
    cooking: "Варити 6–7 хв після спливання у підсоленій воді з лавровим листом.",
    storage: "Зберігати за −18 °C до 30 діб.",
    allergens: "Глютен (пшениця), молоко.",
    images: PH, isActive: true,
  },
  {
    id: "pelmeni-dytyachi", slug: "pelmeni-dytyachi-kolorovi", categorySlug: "pelmeni",
    title: "Пельмені дитячі «Кольорові»", weightGrams: 500, unitLabel: "упаковка 0,5 кг",
    priceUAH: 289, tags: ["new"],
    composition: "Борошно пшеничне в/ґ, філе індички та куряче, натуральні соки (буряк, шпинат, морква), вода, сіль.",
    kbju: { kcal: 218, protein: 13, fat: 7, carb: 26 },
    cooking: "Варити 5–6 хв після спливання на невеликому вогні.",
    storage: "Зберігати за −18 °C до 30 діб.",
    allergens: "Глютен (пшениця).",
    images: PH, isActive: true,
  },
  ...
  {
    id: "ravioli-myaso", slug: "ravioli-z-myasom", categorySlug: "pelmeni",
    title: "Равіолі з м'ясом", weightGrams: 700, unitLabel: "упаковка 0,7 кг",
    priceUAH: 299, tags: [],
    composition: "Борошно твердих сортів пшениці, яловичина, свинина, пармезан, мускатний горіх, сіль, яйце.",
    kbju: { kcal: 238, protein: 12, fat: 10, carb: 25 },
    cooking: "Варити 4–5 хв після спливання. Подавати з томатним соусом або розтопленим вершковим маслом.",
    storage: "Зберігати за −18 °C до 30 діб.",
    allergens: "Глютен (пшениця), молоко, яйця.",
    images: PH, isActive: true,
  },
  ...
  {
    id: "khachapuri-imeretynske", slug: "khachapuri-po-imeretynsky", categorySlug: "pizza-pyrohy",
    title: "Хачапурі по-імеретинськи", weightGrams: 450, unitLabel: "1 шт · Ø 26 см",
    priceUAH: 249, tags: ["hit"],
    composition: "Дріжджове тісто, подвійна начинка з сиру сулугуні та бринзи, вершкове масло, яйце.",
    kbju: { kcal: 284, protein: 14, fat: 14, carb: 26 },
    cooking: "Випікати в духовці 200 °C 12–15 хв до рум'яності. Змастити вершковим маслом.",
    storage: "Зберігати за −18 °C до 30 діб.",
    allergens: "Глютен (пшениця), молоко, яйця.",
    images: PH, isActive: true,
  },
  ...
  {
    id: "chebureky-syr-zelen", slug: "chebureky-z-syrom-suluguni-ta-zelennyu", categorySlug: "pizza-pyrohy",
    title: "Чебуреки з сулугуні та зеленню", weightGrams: 500, unitLabel: "упаковка 0,5 кг · ~5 шт",
    priceUAH: 269, tags: ["hit"],
    composition: "Борошно пшеничне, вода, олія, сир сулугуні, бринза, кріп, кінза, сіль.",
    kbju: { kcal: 258, protein: 11, fat: 13, carb: 24 },
    cooking: "Смажити у розігрітій олії по 3–4 хв з кожного боку до хрусткої скоринки.",
    storage: "Зберігати за −18 °C до 30 діб.",
    allergens: "Глютен (пшениця), молоко.",
    images: PH, isActive: true,
  },
  ...
  // ---------- Сирники ----------
  {
    ...
    title: "Сирники класичні", weightGrams: 500, unitLabel: "упаковка 0,5 кг · ~10 шт",
    priceUAH: 319, tags: ["hit"],
  ...
  },
  {
    ...
    title: "Сирники з родзинками", weightGrams: 500, unitLabel: "упаковка 0,5 кг · ~10 шт",
    priceUAH: 329, tags: ["hit"],
    composition: "Сир кисломолочний 9%, родзинки світлі без кісточок, борошно пшеничне, цукор, ваніль, яйця, сіль.",
    kbju: { kcal: 234, protein: 13, fat: 7, carb: 30 },
    cooking: "Смажити на помірному вогні по 4 хв з кожного боку під кришкою.",
    storage: "Зберігати за −18 °C до 30 діб.",
    allergens: "Глютен (пшениця), молоко, яйця.",
    images: PH, isActive: true,
  },
  {
    id: "syrnyky-mak", slug: "syrnyky-z-makom", categorySlug: "syrnyky",
    title: "Сирники з маком", weightGrams: 500, unitLabel: "упаковка 0,5 кг · ~10 шт",
    priceUAH: 339, tags: ["new"],
    composition: "Сир кисломолочний 9%, кондитерський мак, борошно пшеничне, яйце, цукор, ванільний цукор.",
    kbju: { kcal: 242, protein: 13, fat: 9, carb: 28 },
    cooking: "Смажити на вершковому маслі або олії під кришкою 4 хв з кожного боку.",
    storage: "Зберігати за −18 °C до 30 діб.",
    allergens: "Глютен (пшениця), молоко, яйця.",
    images: PH, isActive: true,
  },
  ...
  {
    id: "syrnyky-soloni-zelen", slug: "syrnyky-soloni-z-zelennyu", categorySlug: "syrnyky",
    title: "Сирники солоні з зеленню та бринзою", weightGrams: 500, unitLabel: "упаковка 0,5 кг · ~10 шт",
    priceUAH: 329, tags: [],
    composition: "Сир кисломолочний, бринза, кріп свіжий, зелена цибуля, яйця курячі, борошно, сіль, часник сушений.",
    kbju: { kcal: 218, protein: 14, fat: 8, carb: 22 },
    cooking: "Смажити на розігрітій пательні по 3–4 хв з кожного боку. Подавати зі сметаною або соусом тар-тар.",
    storage: "Зберігати за −18 °C до 30 діб.",
    allergens: "Глютен (пшениця), молоко, яйця.",
    images: PH, isActive: true,
  },
...
const officialCategoryFallbacks: Record<string, string> = {
  ...
  vareniki: "https://galia-baluvana.com/storage/uploads/images/KdMZjg5dZ5QG6uQr7GodVtCN6UxR0n9kxekcYvuM/KdMZjg5dZ5QG6uQr7GodVtCN6UxR0n9kxekcYvuM_res600x400_opt.jpg",
  mlyntsi: "https://galia-baluvana.com/storage/uploads/images/KdMZjg5dZ5QG6uQr7GodVtCN6UxR0n9kxekcYvuM/KdMZjg5dZ5QG6uQr7GodVtCN6UxR0n9kxekcYvuM_res600x400_opt.jpg",
  ...
  golubtsi: "https://galia-baluvana.com/storage/uploads/images/XexPEvNeq9NWpZFWzuWcSM8hyHCJoWsuRfFpi3F2/XexPEvNeq9NWpZFWzuWcSM8hyHCJoWsuRfFpi3F2_res600x400_opt.jpg",
  ...
  gotovi: "https://galia-baluvana.com/storage/uploads/images/7FojIlejzfiFGAAIbyc90zp23Q3zAOv99aZfzZ6U/7FojIlejzfiFGAAIbyc90zp23Q3zAOv99aZfzZ6U_res600x400_opt.jpg",
};
