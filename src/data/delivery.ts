...
export const deliveryZones: DeliveryZone[] = [
  {
    id: "cv-city",
    name: "Місто Чернівці (усі райони)",
    costUAH: 70,
    freeFromUAH: DELIVERY_FREE_FROM_UAH,
    eta: "45–75 хв",
    note: "Доставка кур'єром у термобоксі до дверей.",
  },
  {
    id: "cv-suburb",
    name: "Передмістя Чернівців (до 15 км)",
    costUAH: 120,
    freeFromUAH: 2000,
    eta: "60–90 хв",
    note: "Коровія, Мамаївці, Чагор, Остриця, Годилів тощо.",
  },
  {
    id: "pickup",
    name: "Самовивіз із магазину у Чернівцях",
    costUAH: 0,
    freeFromUAH: 0,
    eta: "від 15 хв",
    note: "14 локацій у всіх районах міста на ваш вибір.",
  },
];
