...
const staticRoutes: Route[] = [
  {
    ...
    description:
      "Вареники, пельмені, млинці, сирники, голубці, котлети ручного ліплення. Асортимент по категоріях, карта магазинів, рецепти.",
    h1: "Приділіть свій час коханим",
    intro:
      "Домашні напівфабрикати «Галя Балувана»: тісто й начинки ручного ліплення, без сої та консервантів. Асортимент по категоріях; ціни та наявність — у магазині.",
  },
  {
    path: "/menu",
    title: "Меню — домашні напівфабрикати Галя Балувана",
    description:
      "Повний асортимент по категоріях: вареники, пельмені, млинці, сирники, чебуреки, голубці, котлети, піца, випічка ручного ліплення.",
    h1: "Меню",
    intro: "16 категорій ручного ліплення з натуральних продуктів. Ціни та наявність — у магазині.",
  },
  {
    path: "/delivery",
